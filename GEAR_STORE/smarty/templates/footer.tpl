      ...
      $(".button").click(function(){
		...
		function chi_tiet_san_pham(ma_san_pham,ten_san_pham)
		{
			window.location='ten_san_pham.php?ma_san_pham='+ma_san_pham+'&ten_san_pham='+ten_san_pham
                 ...
                 {literal}<script type='text/javascript' data-cfasync='false'>window.purechatApi = { l: [], t: [], on: function () { this.l.push(arguments); } }; (function () { var done = false; var script = document.createElement('script'); script.async = true; script.type = 'text/javascript'; script.src = 'https://app.purechat.com/VisitorWidget/WidgetScript'; document.getElementsByTagName('HEAD').item(0).appendChild(script); script.onreadystatechange = script.onload = function (e) { if (!done && (!this.readyState || this.readyState == 'loaded' || this.readyState == 'complete')) { var w = new PCWidget({c: 'b535038f-ff99-44bd-b14b-5ad388509e17', f: true }); done = true; } }; })();</script>{/literal}
