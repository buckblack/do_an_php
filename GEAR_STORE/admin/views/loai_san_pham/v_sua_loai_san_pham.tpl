  ...
  <div class="tab-content default-tab" id="tab1">
    <form action="#" method="post" enctype="multipart/form-data">
		...
		<p>
            ...
            <input hidden="" class="text-input small-input" type="text" id="them_loai_ma_loai" name="them_loai_ma_loai" value="{$loai_san_pham->ma_loai}" />
		  </p>
		<p>
            <label>Tên loại</label>
            <input class="text-input small-input" type="text" id="them_loai_ten_loai" name="them_loai_ten_loai" value="{$loai_san_pham->ten_loai}" />
		  </p>
          <p>
