...
<title>GEAR STORE | Đăng nhập</title>
...
<body id="login">
		<div id="login-wrapper" class="png_bg">
			<div id="login-top">
                <h1>Quản lý Gear Store</h1>
				<!-- Logo (221px width) -->
				<img id="logo" src="../public/images/logo/logo.png" width="170px" alt="Nhà Hàng Admin logo" />
			</div> <!-- End #logn-top -->
			
			<div id="login-content">
				<form action="quantri.php" method="post"><!-- xử lý ở trang quantri.php -->
